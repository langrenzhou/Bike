...
import CommodityList from '../../Component/CommodityList'
class Commodity extends Component {
    ...
    componentWillMount() {
      ...
      console.log(this.state)
        ...
        let { name } = this.state
        switch (type) {
            case 'liqueur': name = '比克酒家'
                break;
            case 'Phone': name = '比克3c'
                break;
            case 'Cloths': name = '比克服饰'
                break;
            case 'home': name = '比克家电'
                break;
            case 'makeups': name = '美妆馆'
                break;
            case 'medicine': name = '药到家'
                break;
            case 'snacks': name = '零食天地'
                break;
            case 'Supermakerts': name = '比克超市'
        }
        this.setState({ name })
