          ...
          Taro.navigateBack();
                ...
                <View>
                    ...
                    <View className="CodeInput">
                        <AtInput onChange={this.ChangeInput.bind(this, 'Code')} style="padding:0;" clear type={this.state.Pwd ? "password" : "number"} placeholder={this.state.Pwd ? '请输入密码' : "请输入收到的验证码"} maxLength={this.state.Pwd ? '16' : '6'} value={this.state.Code}>
